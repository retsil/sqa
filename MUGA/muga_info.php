...
<h2 class="sqa">The GBPS Audit</h2>
<div class="sqap">
...
The download below contains the data for the GBPS audit.  The data are in compressed form as a single file.  They have been compressed using pkzip.
</div>
...
<div class="sqap">
The download contains 12 GBPS studies in interfile 3.3 format containing separate header and data files.  The header and data file names are p1muga.hdr, p1muga.img, p2muga.hdr etc.
